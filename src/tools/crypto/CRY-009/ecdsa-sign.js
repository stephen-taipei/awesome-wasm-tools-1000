/**
 * CRY-009: ECDSA Digital Signature Tool
 *
 * Uses Web Crypto API to create ECDSA digital signatures.
...
class ECDSASigner {
  ...
  async sign() {
    ...
    try {
      ...
      this.showStatus('success', 'ECDSA 數位簽章建立完成！');
    } catch (error) {
...
document.addEventListener('DOMContentLoaded', () => {
  window.ecdsaSigner = new ECDSASigner();
});
