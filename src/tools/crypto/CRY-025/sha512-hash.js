/**
 * CRY-025: SHA-512 Hash Tool
 * Uses Web Crypto API. SHA-512 produces a 512-bit (64-byte) hash value.
 */
...
class SHA512Hash {
  ...
  async hash() {
    ...
    try {
      ...
      this.showStatus('success', 'SHA-512 雜湊計算完成！');
...
document.addEventListener('DOMContentLoaded', () => { window.sha512Hash = new SHA512Hash(); });
