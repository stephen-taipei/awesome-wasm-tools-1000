...
class PDFTool {
  ...
  download() {
    ...
    link.download = this.file.name.replace(/\.pdf$/i, '_processed.pdf');
...
document.addEventListener('DOMContentLoaded', () => { window.pdfTool = new PDFTool(); });
