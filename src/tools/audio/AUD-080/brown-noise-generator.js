/**
 * AUD-080: Brown Noise Generator
 * Generate brown noise (Brownian noise) audio files
 */
...
generateBtn.addEventListener('click', generateBrownNoise);
  ...
  setTimeout(() => {
    ...
    for (let ch = 0; ch < 2; ch++) {
      ...
      for (let i = 0; i < numSamples; i++) {
        ...
        lastOut[ch] = (lastOut[ch] + (0.02 * white)) / 1.02;
        data[i] = lastOut[ch] * 3.5 * vol; // Amplify and apply volume
    ...
    generateBtn.innerHTML = '<span>🎵</span> 生成棕噪音';
  }, 100);
}
...
function downloadResult() {
  ...
  link.download = `brown_noise_${durationSlider.value}s.wav`;
  link.click();
