/**
 * CMP-092: Arithmetic 壓縮
 * 算術編碼壓縮
 */
class CompressTool092 {
...
document.addEventListener('DOMContentLoaded', () => { window.compressTool092 = new CompressTool092(); });
export default CompressTool092;