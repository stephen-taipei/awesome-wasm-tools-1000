/**
 * CMP-093: Arithmetic 解壓
 * 算術編碼解壓
 */
class CompressTool093 {
...
document.addEventListener('DOMContentLoaded', () => { window.compressTool093 = new CompressTool093(); });
export default CompressTool093;