/**
 * CMP-101: Self-Extract 建立
 * 建立自解壓縮檔
 */
class CompressTool101 {
...
document.addEventListener('DOMContentLoaded', () => { window.compressTool101 = new CompressTool101(); });
export default CompressTool101;