...
class CAL130Calculator {
  ...
  compute(input) {
    ...
    return `<p><strong>輸入:</strong> ${input}</p><p><strong>功能:</strong> F分布計算</p><p><strong>結果:</strong> ${num}</p>`;
  }
  clear() {
...
document.addEventListener('DOMContentLoaded', () => { window.calculator = new CAL130Calculator(); });
export default CAL130Calculator;
