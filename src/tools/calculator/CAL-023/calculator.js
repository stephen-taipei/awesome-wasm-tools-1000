...
class CAL023Calculator {
  ...
  compute(input) {
    ...
    return `<p><strong>輸入:</strong> ${input}</p><p><strong>功能:</strong> 平均值計算器</p><p><strong>結果:</strong> ${num}</p>`;
  }
  clear() {
...
document.addEventListener('DOMContentLoaded', () => { window.calculator = new CAL023Calculator(); });
export default CAL023Calculator;
