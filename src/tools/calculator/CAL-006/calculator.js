/**
 * CAL-006: 三角函數計算器
 * 計算 sin, cos, tan 等三角函數
 */
class CAL006Calculator {
  ...
  compute(input) {
    ...
    return `<p><strong>輸入:</strong> ${input}</p><p><strong>功能:</strong> 三角函數計算器</p><p><strong>結果:</strong> ${num}</p>`;
  }
  clear() {
...
document.addEventListener('DOMContentLoaded', () => { window.calculator = new CAL006Calculator(); });
export default CAL006Calculator;
