...
class CAL066Calculator {
  ...
  compute(input) {
    ...
    return `<p><strong>輸入:</strong> ${input}</p><p><strong>功能:</strong> 能量單位換算</p><p><strong>結果:</strong> ${num}</p>`;
  }
  clear() {
...
document.addEventListener('DOMContentLoaded', () => { window.calculator = new CAL066Calculator(); });
export default CAL066Calculator;
