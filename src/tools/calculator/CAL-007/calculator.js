/**
 * CAL-007: 反三角函數計算器
 * 計算 arcsin, arccos, arctan
 */
class CAL007Calculator {
  ...
  compute(input) {
    ...
    return `<p><strong>輸入:</strong> ${input}</p><p><strong>功能:</strong> 反三角函數計算器</p><p><strong>結果:</strong> ${num}</p>`;
  }
  clear() {
...
document.addEventListener('DOMContentLoaded', () => { window.calculator = new CAL007Calculator(); });
export default CAL007Calculator;
